...
const page: React.FC = () => {
  return (
    <div className="terms-container border text-white bg-black p-6 mt-4">
      <h2 className="text-5xl font-bold mb-4">Terms &amp; Conditions</h2>
      <p>Last updated on 29-02-2024 17:28:45</p>
      <p>
        These Terms and Conditions, along with privacy policy or other terms
        (&ldquo;Terms&rdquo;) constitute a binding agreement by and between SRM TRUST AP,
        (&ldquo;Website Owner&rdquo; or &ldquo;we&rdquo; or &ldquo;us&rdquo; or &ldquo;our&rdquo;) and you (&ldquo;you&rdquo; or &ldquo;your&rdquo;) and
        relate to your use of our website, goods (as applicable) or services (as
        applicable) (collectively, &ldquo;Services&rdquo;).
      </p>
      <p>
      ...
      {/* Continue with the rest of the terms using &apos;, &quot;, etc. where needed */}
      <p>
      ...
      <p>
        ...
        jurisdiction of the courts in VIJAYAWADA (URBAN), Andhra Pradesh.
      </p>
      <p>
