...
const About = () => {
  return (
    <div className="container mx-auto my-10">
      <h1 className="text-3xl lg:text-4xl font-bold mb-8 text-center">About Us</h1>
      <div className="flex flex-col lg:flex-row items-center lg:justify-between p-8">
        ...
        <div className="lg:w-1/2 flex flex-col gap-10">
          <h2 className="text-2xl lg:text-3xl font-semibold mb-4 lg:mb-6 text-center lg:text-left ">
