...
const teamMembers = [
  ...
  { id: 10, name: "Prachi Dash",designation:"Writers Co", imageSrc: "/images/team/pra.jpeg" },
  { id: 11, name: "Rohan Middella",designation:"Public Relations", imageSrc: "/images/team/rohannew.jpeg" },
];
