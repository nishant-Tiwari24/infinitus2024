  ...
  return (
    <div className="container items-center mx-auto max-h-screen my-10">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between p-8 gap-16">
        ...
        <div className="lg:w-1/2">
          <h2 className="text-4xl lg:text-5xl font-space font-semibold mb-4 lg:mb-6 text-left lg:text-left bg-clip-text text-transparent bg-gradient-to-b from-green-200 to-[#d6a6dc]">
