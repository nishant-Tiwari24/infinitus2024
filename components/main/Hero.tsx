  ...
  return (
    <section style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', paddingTop: 250}} className='flex-col'>
      ...
      <div className='flex flex-col justify-center gap-28'>
        <motion.div className='pt-14' style={{ margin: '10px 0' }} variants={slideInFromLeft(0.8)} initial="initial" animate="animate">
          <Timer />
        </motion.div>
        <motion.button
          ...
          variants={slideInFromRight(1)} initial="initial" animate="animate"
        >
          Register Now
        </motion.button>
      </div>
