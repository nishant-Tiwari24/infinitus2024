...
function Events() {
  const eventData = [
    { title: "Cultural Fest Events", imageSrc: "/images/maffick-shows.jpeg" , name:"Cultural Events", href:"/events/cultural"},
    { title: "Technical Fest Events", imageSrc: "/images/maffick-shows.jpg", name:"Technical Event" , href:"/events/technical"},
    { title: "Non Technical Events", imageSrc: "/images/maffick-shows.jpg", name:"Technical Event" , href:"/events/nontechnical"}
  ];
  return (
