...
const Navbar = () => {
  ...
  return (
    <div className={`flex justify-between items-center w-full h-28 p-5 border-purple-400 border-b-1 text-white  z-40 fixed top-0 left-0 ${nav ? 'nav-open' : ''}`} style={{backgroundColor:'#030014'}}>
