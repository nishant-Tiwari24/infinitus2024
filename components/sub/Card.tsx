...
export function ThreeDCardDemo() {
  return (
    <CardContainer className="inter-var flex gap-20 flex-col sm:flex-row">
      <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-[40rem] sm:w-[60rem]  sm:h-[60rem] h-auto rounded-xl p-6 border  ">
        <CardItem
          translateZ="50"
